...
if __name__ == "__main__":
    ...
    encoder_config_path = 'configs/train-m.yaml'
    config = OmegaConf.load(encoder_config_path)
    ...
    train_config_path = 'configs/train-m.yaml'
    config = OmegaConf.load(train_config_path)
    decoder = Decoder(**config.model.get("ddconfig-l2h", dict()))
    res = decoder(z,skips)
    print(res.shape)
